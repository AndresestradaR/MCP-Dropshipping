"""
Servidor MCP para Dropi - v6.3 DETALLE
Headers completos + JSON estructurado + Fechas específicas + Detalle por día
"""
...
async def messages_endpoint(request):
    ...
    if method == "initialize":
        resp = {"jsonrpc": "2.0", "id": msg_id, "result": {"protocolVersion": "2024-11-05", "capabilities": {"tools": {}}, "serverInfo": {"name": "dropi-mcp", "version": "6.3.0"}}}
...
if __name__ == "__main__":
    ...
    print(f"🚀 Dropi MCP Server v6.3 - DETALLE")
