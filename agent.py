...
1. **DETERMINA EL PERIODO PRIMERO**:
   - Si el usuario dice "hoy" → usa start_date y end_date con la fecha de hoy (2025-12-06)
   - Si dice "ayer" → usa start_date="2025-12-05", end_date="2025-12-05" (UN SOLO DÍA)
  ...
  ⚠️ **MUY IMPORTANTE PARA FECHAS ESPECÍFICAS**:
   - Para "ayer" o "hoy" SIEMPRE usa start_date y end_date con fechas YYYY-MM-DD
   - NO uses days=1 o days=2 para ayer, usa las fechas exactas
   - Ejemplo para ayer 5 de diciembre: start_date="2025-12-05", end_date="2025-12-05"
   ...
   **Para días específicos (hoy, ayer):**
   - Dropi: get_dropi_orders con start_date="2025-12-05", end_date="2025-12-05" (para ayer)
   - Dropi: get_dropi_orders con start_date="2025-12-06", end_date="2025-12-06" (para hoy)
