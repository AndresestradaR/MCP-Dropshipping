...
from fastapi.middleware.cors import CORSMiddleware  # ← AGREGADO PARA DASHBOARD
...
# ========================================
# CORS - AGREGADO PARA DASHBOARD
# ========================================
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://dashboard-empresarial-mcp-production.up.railway.app",  # Dashboard Railway
...
async def get_dashboard_data(request: Request):
    ...
    Retorna datos agregados de todas las plataformas (Meta, Shopify, Dropi, TikTok).
    ...
    try:
        ...
        # TODO: Aquí llamarías a las herramientas MCP para obtener datos reales
        # Por ahora retornamos estructura mock para que el frontend funcione
        
        # Ejemplo de cómo llamar herramientas MCP:
        # dropi_wallet = await mcp_client.call_tool("dropi", "get_wallet", {"date_range": ...})
        # meta_insights = await mcp_client.call_tool("meta", "get_insights", {"date_range": ...})
        ...
        response_data = {
            ...
            "master": {
                ...
                "ingresosDropi": 0,  # Pagos recibidos
                "egresosDropi": 0,  # Costos de órdenes
                "profitNeto": 0,  # Ingresos - Gastos
                "roi": 0  # (Profit / Gastos) * 100
            },
            "dropi": {
                "pedidos": 0,
                "entregas": 0,
                "devoluciones": 0,
                "entradas": [],  # [{fecha, monto, concepto}]
                "salidas": [],   # [{fecha, monto, concepto}]
                "saldo": 0
            },
            "meta": {
                "gasto": 0,
                ...
                "ctr": 0,
                "cpa": 0,
                "historico": []  # [{fecha, gasto, impresiones, clics}]
            },
            "tiktok": {
                "gasto": 0,
                "presupuesto": 0,
