...
def parse_mcp_result(result):
    ...
    Los servidores MCP retornan strings JSON que necesitan ser parseados.
    """
    if result is None:
        return None
    ...
    if isinstance(result, str):
        try:
            ...
            logger.warning(f"No se pudo parsear como JSON: {result[:100]}")
            return None
...
async def get_dashboard_data(request: Request):
    ...
    try:
        ...
        try:
            ...
            wallet_raw = await mcp_client.call_tool("dropi", "get_wallet", {})
            ...
            history_raw = await mcp_client.call_tool("dropi", "get_wallet_history", {
            ...
            orders_raw = await mcp_client.call_tool("dropi", "get_orders", {
                "start_date": start_date,
                "end_date": end_date
            })
            ...
            if orders_result and isinstance(orders_result, list):
                ...
                logger.info(f"📦 Pedidos: {dropi_data['pedidos']}, Entregas: {dropi_data['entregas']}")
        ...
        try:
            ...
            if period_label in ["Hoy", "Today"]:
                ...
                period = "last_30d"  # Default seguro
        ...
        # =================================================================
        # PASO 3: OBTENER DATOS DE TIKTOK (Mock por ahora)
        # =================================================================
