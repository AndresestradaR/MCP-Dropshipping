"""
Servidor MCP para Shopify - COMPLETO
Todas las herramientas para consultar tu tienda.
"""
...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Obtiene los pedidos recientes con detalles: cliente, productos, valor, estado. Usa limit para controlar cuantos (default 10)",
        "inputSchema": {
            "type": "object",
            "properties": {
...
async def get_recent_orders(args: dict) -> str:
    ...
    for o in orders:
        ...
        name = f"{customer.get('first_name', '')} {customer.get('last_name', '')}".strip() or "Sin nombre"
...
👤 CLIENTE:
   Nombre: {customer.get('first_name', '')} {customer.get('last_name', '')}
