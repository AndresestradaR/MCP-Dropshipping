...
# Inicializar el servidor usando FastMCP (La forma moderna)
...
async def get_total_sales_today() -> str:
    ...
    # Aseguramos que la URL no tenga https:// si el usuario lo puso
...
if __name__ == "__main__":
    # Railway nos da el puerto en la variable PORT, usamos 3000 por defecto
    port = int(os.getenv("PORT", 3000))
    # Iniciamos el servidor en modo SSE y escuchando en 0.0.0.0 (Vital para Railway)
