...
class MCPClient:
    def __init__(self):
        ...
        self.sessions = {}  # Para compatibilidad con server.py
            ...
            try:
                ...
                async with httpx.AsyncClient(timeout=30.0) as client:
                    ...
                    if response.status_code == 200:
                        ...
                        self.sessions[name] = True  # Marcar como conectado
    ...
    async def get_all_tools(self):
        ...
        for server_name, tools in self.tools_cache.items():
            for tool in tools:
                # Crear nombre unico: servidor_herramienta
